$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-vacuum-xiaomi-vacuum-cleaner"] = new basevacuum("default-vacuum-xiaomi-vacuum-cleaner", "", "blur_light", {'widget_type': 'basevacuum', 'entity': 'vacuum.xiaomi_vacuum_cleaner', 'fields': {'title': 'Escrava Isaura'}, 'css': {}, 'static_icons': [], 'static_css': {'title_style': 'color: #646464;font-weight: 400;', 'widget_style': 'backdrop-filter: blur(30px);background-color: rgba(255, 255, 255, 0.5);'}, 'use_comma': 0, 'precision': 1, 'use_hass_icon': 0, 'namespace': 'default'})
